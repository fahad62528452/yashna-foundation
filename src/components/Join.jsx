...
export default function Join() {
  ...
  return (
    <section id="join" ref={root} className="px-5 py-24 md:px-8 md:py-32">
      <div className="mx-auto max-w-6xl">
        <p className="text-[11px] tracking-[0.34em] text-blood uppercase">Stand with us</p>
        <h2 className="font-display mt-4 max-w-2xl text-4xl md:text-6xl">Four ways to share a life.</h2>
          ...
          {ways.map((way) => {
            ...
            return (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="join-card group rounded-3xl border border-ink/10 bg-paper p-7 transition-transform duration-300 hover:-translate-y-1"
              >
                <span className="grid h-11 w-11 place-items-center rounded-full bg-blood/10 text-blood">
                  <Icon size={18} />
                </span>
                <h3 className="font-display mt-5 text-3xl">{way.title}</h3>
